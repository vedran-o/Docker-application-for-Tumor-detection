...
My task was to create backend ML model, database (I tried Posteger, MySQL and MariaDB) and to deploy Flask app (I created initial HTML site in frontend and connected it with Jinja to backend).
